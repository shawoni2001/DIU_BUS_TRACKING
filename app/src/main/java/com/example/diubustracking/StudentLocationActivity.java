...
public class StudentLocationActivity extends AppCompatActivity implements OnMapReadyCallback, RoutingListener {
        ...
        call.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
              ...
              //  intent.setData(Uri.parse("tel:"+phone.trim()));
                ...
                {
                    Toast.makeText(StudentLocationActivity.this, "Could not find an activity to place the call.", Toast.LENGTH_SHORT).show();
                }


               /* if (ActivityCompat.checkSelfPermission(StudentLocationActivity.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED)
                {
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        {
            Intent intent = new Intent(StudentLocationActivity.this,AboutActivity .class);
            startActivity(intent);
        }
    ...
    LocationCallback mLocationCallback = new LocationCallback()
    {
        ...
        public void onLocationResult(LocationResult locationResult)
        {
            ...
            if (locationList.size() > 0)
            {
                ...
                Log.i("StudentLocationActivity", "Location: " + location.getLatitude() + " " + location.getLongitude());
                ...
                new AlertDialog.Builder(this)
                        ...
                        .setPositiveButton("OK", new DialogInterface.OnClickListener()
                        {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i)
                            {
                                ...
                                ActivityCompat.requestPermissions(StudentLocationActivity.this,
   ...
   /* @Override
    public boolean onMarkerClick(Marker marker)
    {
        Routing routing = new Routing.Builder()
                ...
                .withListener(StudentLocationActivity.this)
